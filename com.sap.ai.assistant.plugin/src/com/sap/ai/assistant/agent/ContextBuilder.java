...
public class ContextBuilder {
    ...
    public static final String CODE_REVIEW_SYSTEM_PROMPT =
            ...
            + "## ABAP Cleaner\n\n"
            + "If the `abap_cleaner` tool is available, use it to automatically apply Clean ABAP "
            + "formatting and style rules to the code. This handles ~100 cleanup rules including:\n"
            ...
            + "Use profile='default' for all rules or profile='essential' for core Clean ABAP only.\n\n"
            + "## Guidelines\n\n"
