...
public class ContextBuilder {
    ...
    public static final String CODE_REVIEW_SYSTEM_PROMPT =
            ...
            + "## ABAP Cleaner\n\n"
            + "Use the `abap_cleaner` tool to automatically apply Clean ABAP formatting and style rules. "
            + "This handles ~100 cleanup rules including:\n"
            + "- Modern syntax: inline declarations, NEW, VALUE, string templates\n"
            + "- Formatting: spacing, alignment, empty lines\n"
            + "- Comments: cleanup and standardization\n\n"
            + "Profiles: 'default' (all rules), 'essential' (core rules), or custom team profiles.\n\n"
            + "If ABAP Cleaner is not installed, suggest the user install it from:\n"
            + "https://sap.github.io/abap-cleaner/updatesite (Eclipse update site)\n\n"
            + "## Guidelines\n\n"
