...
public class ResearchTool implements SapTool {
    ...
    private static final String SYSTEM_PROMPT =
            ...
            + "- `sap_get_source` — read source code of a program, class, interface, or function module\n"
            + "- `sap_object_structure` — get the structure/hierarchy of an ABAP object (methods, includes, etc.)\n"
            + "- `sap_node_contents` — list children of a package or namespace\n"
            + "- `sap_find_definition` — navigate to where a symbol (class, method, type, variable) is defined\n"
            + "- `sap_usage_references` — find all places where a symbol is used (where-used list)\n\n"
            ...
            + "Use them to look up syntax, APIs, BAdIs, configuration, and best practices.\n\n"
            + "## Guidelines\n\n"
